            ...
            <div class="row" id="padding">
                <div class="col-sm-2" id="center">
                    <div class="list-group">
                        ...
                        <a href="suppression_utilisateur.php" class="list-group-item active" <?php echo $display_admin; ?>> Supprimer un utilisateur</a>
                ...
                <div class="col-sm-10"><br>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2 class="panel-title" id="titre_salon"> Supprimer un utilisateur</h2>
                        </div>
